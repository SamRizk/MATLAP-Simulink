...
% Last Modified by GUIDE v2.5 18-Dec-2022 04:41:11
...
if ~all(num2) && op=='/'
    set(handles.errCon_axis, 'String', 'Can not Divide by 0'); 
    set(handles.errCon_axis, 'Visible', 'on'); 
else
...
% --- Executes on button press in x_plot.
function x_plot_Callback(hObject, eventdata, handles)
% hObject    handle to x_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of x_plot


% --- Executes on button press in y_plot.
function y_plot_Callback(hObject, eventdata, handles)
% hObject    handle to y_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of y_plot


% --- Executes on button press in xy_plot.
function xy_plot_Callback(hObject, eventdata, handles)
% hObject    handle to xy_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of xy_plot


% --- Executes on button press in resultant_plot.
function resultant_plot_Callback(hObject, eventdata, handles)
% hObject    handle to resultant_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of resultant_plot


% --- Executes on button press in sin_plot.
function sin_plot_Callback(hObject, eventdata, handles)
% hObject    handle to sin_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of sin_plot


% --- Executes on button press in equation_plot.
function equation_plot_Callback(hObject, eventdata, handles)
% hObject    handle to equation_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of equation_plot


% --- Executes on button press in cos_plot.
function cos_plot_Callback(hObject, eventdata, handles)
% hObject    handle to cos_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of cos_plot
...
function wal_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to wal (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
